...
class DataBaseService {
  ...
  Future saveData(String user, String password, String id, String department,
      String passingYear, List modelData) async {
    String userData =
        user + ':' + password + ":" + id + ":" + department + ":" + passingYear;
    _db[userData] = modelData;
